...
void GroveTwoRGBLedMatrixClass::displayNumber(int16_t number, uint16_t duration_time, bool forever_flag,
                                              uint8_t color)
{
    uint8_t data[7] = {
        0,
...
void GroveTwoRGBLedMatrixClass::displayString(const char *str, uint16_t duration_time, bool forever_flag, uint8_t color)
{
    uint8_t data[36] = {
        0,
    },
...
void GroveTwoRGBLedMatrixClass::displayFrames(uint64_t *buffer, uint16_t duration_time, bool forever_flag,
                                              uint8_t frames_number)
{
    uint8_t data[72] = {
        0,
...
void GroveTwoRGBLedMatrixClass::displayFramesFromFlash(uint16_t duration_time, bool forever_flag, uint8_t from,
                                                       uint8_t to)
{
    uint8_t data[6] = {
        0,
